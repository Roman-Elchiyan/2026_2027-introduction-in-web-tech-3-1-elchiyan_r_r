...
Директива `Disallow: /ftp` не запрещает пользователю обращаться к каталогу. Она предназначена для поисковых роботов и указывает, что данный путь не следует индексировать.
