...
Сервер вернул HTTP/1.1 200 OK и содержимое файла acquisitions.md, то есть файл из /ftp был доступен напрямую без авторизации. 

Сам по себе код 200 OK этого не доказывает, поэтому дополнительно проверялось тело ответа — там находился именно запрошенный файл.
